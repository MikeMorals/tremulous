...
enum cgameExport_t {
    ...
    // main game system.
    // use Cmd_Argc() / Cmd_ArgvBuffer() to read the command, return false if the
    ...
    // use Cmd_Argc() / Cmd_ArgvBuffer() to read it
    ...
    // uses Cmd_ArgvBuffer and Cmd_Argc to read the command line
