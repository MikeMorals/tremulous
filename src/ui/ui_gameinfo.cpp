...
void UI_LoadArenas(void)
{
    ...
    Com_Printf("[skipnotify]%i arenas parsed\n", ui_numArenas);
...
void UI_ServerInfo(void)
{
    ...
    {
        Cvar_Set("ui_serverinfo_mapname", Info_ValueForKey(info, "mapname"));
        Cvar_Set("ui_serverinfo_timelimit", Info_ValueForKey(info, "timelimit"));
        Cvar_Set("ui_serverinfo_sd", Info_ValueForKey(info, "g_suddenDeathTime"));
        UI_EscapeEmoticons(hostname, Info_ValueForKey(info, "sv_hostname"), sizeof(hostname));
        Cvar_Set("ui_serverinfo_hostname", hostname);
        Cvar_Set("ui_serverinfo_maxclients", Info_ValueForKey(info, "sv_maxclients"));
        Cvar_Set("ui_serverinfo_version", Info_ValueForKey(info, "version"));
        Cvar_Set("ui_serverinfo_unlagged", Info_ValueForKey(info, "g_unlagged"));
        Cvar_Set("ui_serverinfo_friendlyFire", Info_ValueForKey(info, "g_friendlyFire"));
        Cvar_Set("ui_serverinfo_friendlyBuildableFire", Info_ValueForKey(info, "g_friendlyBuildableFire"));
        Cvar_Set("ui_serverinfo_allowdl", Info_ValueForKey(info, "sv_allowdownload"));
    }
}
